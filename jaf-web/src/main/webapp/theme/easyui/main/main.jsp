...
<head>
<title>JAF演示系统</title>
<t:base type="JQuery,WdatePicker,EasyUI,Tool"></t:base>
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<!-- 顶部-->
	<div region="north" border="false" title="JAF演示系统"
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" style="vertical-align: text-bottom"><img
					src="<%=path%>/plugin/ui/login/images/toplogo-main.png"> <!--
      <img src="plug-in/login/images/toplogo.png" width="550" height="52" alt="">-->
				</td>
				<td align="right" nowrap>
					<table>
						<tr>
							<td valign="top" height="50"><span style="color: #CC33FF">当前用户:</span><span
								style="color: #666633">(${sessionScope.session_user.userName})
									<span style="color: #CC33FF">用户组</span>:<span
									style="color: #666633">(${sessionScope.session_user.teamName})</span><span
									style="color: #CC33FF">权限组</span>:<span style="color: #666633">(${sessionScope.session_user.roleName})</span></td>
						</tr>
						<tr>
						<td>
							...
							<div id="layout_north_kzmbMenu"
								...
								<div
									onclick="add('修改密码','<%=path%>/sysBaseUser/changePassword.shtml')">
									修改密码</div>
							</div>
							<div id="layout_north_zxMenu"
								...
								<div class="menu-sep"></div>
								<div
									onclick="exit('<%=path%>/security/logout.shtml','确定退出该系统吗 ?',1);">
									退出系统</div>
							</div>
						</td>
						</tr>
	...
	<div region="south" border="false"
		...
		<div align="center" style="color: #CC99FF; padding-top: 2px">
			&copy; 版权所有 <span class="tip"><a href="http://www.JAF.org"
				title="JAF_v1.1 Simple版本">JAF_v1.1</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:<a
				href="#" title="JAF_v1.1 Simple版本">JAF_v1.1</a></span>
		</div>
	</div>
