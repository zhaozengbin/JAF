...
public class SysUserVo extends BaseVo {
	...
	/** 冗余 组列表 */
	private List<SysTeamVo> sysTeamVoList;
	...
	/**
	 * @retrun the sysTeamVoList <br>
	 *
	 *         时间: 2014-4-3 下午3:23:34 <br>
	 */

	public List<SysTeamVo> getSysTeamVoList() {
		return sysTeamVoList;
	}

	/**
	 * @param sysTeamVoList
	 *            the sysTeamVoList to set <br>
	 *
	 *            时间: 2014-4-3 下午3:23:34
	 */
	public void setSysTeamVoList(List<SysTeamVo> sysTeamVoList) {
		this.sysTeamVoList = sysTeamVoList;
	}

	/**
	 * @retrun the sysRoleVoList <br>
	 *
	 *         时间: 2014-4-3 下午3:23:34 <br>
	 */
	...
	/**
	 * @retrun the sysPermissionVoList <br>
	 *
	 *         时间: 2014-4-3 下午3:27:01 <br>
	 */

	public List<SysPermissionVo> getSysPermissionVoList() {
		return sysPermissionVoList;
	}

	/**
	 * @param sysPermissionVoList
	 *            the sysPermissionVoList to set <br>
	 *
	 *            时间: 2014-4-3 下午3:27:01
	 */
	public void setSysPermissionVoList(List<SysPermissionVo> sysPermissionVoList) {
		this.sysPermissionVoList = sysPermissionVoList;
	}
}
