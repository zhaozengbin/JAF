 ...
 * 文件名：GenerateByMyBatisAndOracle.java <br>
 * 版本信息：TODO <br>
...
/**
 * 
 * 类名称：GenerateByMyBatisAndOracle <br>
 * 类描述：生成Oracle方法 <br>
 * 创建人：赵增斌 <br>
 * 修改人：赵增斌 <br>
 ...
 * 
 */
public class GenerateByMyBatisAndOracle extends AbstractGenerateModelFrame {

	/** 输出日志 */
	private static final Logger LOGGER = LoggerUtils
			.getLogger(GenerateByMyBatisAndOracle.class);
	 ...
	 */
	public GenerateByMyBatisAndOracle() {
		super();
	}
	 ...
	 */
	public GenerateByMyBatisAndOracle(AbstractGetData getDate) {
		super(getDate);
	}
	...
	public String getUpdateSelectiveSql(String TABleName,
		...
		for (int i = 1; i < columnList.size(); i++) {
			...
			sb.append(ESpecialCharacters.TAB.getEscape() + "<if test=\""
					+ columnName + " != null ");
